...
\usepackage{iftex} % check if the engine is pdflatex, xetex, or luatex
...
}{}{} % replace the number by the desired string
\makeatother
...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+1-709-320-3009}{\color{black}{\footnotesize\faPhone*}\hspace*{0.13cm}+1 (709) 320-3009}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
